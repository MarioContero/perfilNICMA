...
import {IonPage, IonHeader, IonToolbar, IonTitle, IonContent, IonGrid, 
		...
		IonCardContent, IonItem, IonButton, IonAlert} from '@ionic/react';
				...
				<IonGrid>
					<IonRow>
						<IonCol className='ion-text-center'>
							<IonCard>
								<img alt="Imagen" src="/assets/images/trabajo.jpg" />
								<IonCardHeader>
							...
							<IonCard>
								<img alt="Imagen" src="/assets/images/descanso.jpg" />
								<IonCardHeader>
								...
								<IonCardContent>
									...
									<IonItem lines='none'>
										<IonButton color="success" expand="full" shape="round" id="present-alert"></IonButton>
